...
0000000000000000 T funcao_nao_usada
    ...
    \begin{column}{0.47\textwidth}
      \begin{center}
        \vspace{0.15cm}
        \begin{tikzpicture}
          % Container de arquivo .a (representando a biblioteca estatica que abriga os .o)
          \draw[draw=primary, fill=primary!5, dashed, rounded corners=5pt, thick] (-2.1, -0.4) rectangle (2.1, 2.3);
          \node[font=\scriptsize\color{primary}\bfseries] at (0, 2.05) {libstrutils.a};

          \node[draw=primary!25, fill=white, rounded corners=3pt,
                minimum width=3.8cm, minimum height=0.55cm,
                align=center, font=\scriptsize] (o1) at (0,1.45) {my\_strlen.o};
                
          \node[draw=primary!25, fill=white, rounded corners=3pt,
                minimum width=3.8cm, minimum height=0.55cm,
                align=center, font=\scriptsize] (o2) at (0,0.80) {my\_reverse.o};
                
          \node[draw=danger!45, fill=danger!5, rounded corners=3pt,
                minimum width=3.8cm, minimum height=0.55cm,
                align=center, font=\scriptsize] (o3) at (0,0.15) {nao\_usada.o};
        \end{tikzpicture}
      \end{center}
      \vspace{0.15cm}
